...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        l1.setBounds(280,40,350,40);
        add(l1);
        
        JLabel type = new JLabel("Account Type");
        type.setFont(new Font("Raleway",Font.BOLD,22));
        type.setBounds(100,100,175,30);
        add(type);
        ...
        number.setBounds(300,250,400,30);
        add(number);
        
        JLabel carddetail = new JLabel("Your 16 Digit Card Number");
        carddetail.setFont(new Font("Raleway",Font.BOLD,12));
        carddetail.setBounds(100,280,400,20);
        add(carddetail);
        
        JLabel pin = new JLabel("PIN");
        pin.setFont(new Font("Raleway",Font.BOLD,18));
        pin.setBounds(100,330,400,30);
        add(pin);
        
        JLabel pnumber = new JLabel("XXXX");
        pnumber.setFont(new Font("Raleway",Font.BOLD,18));
        pnumber.setBounds(300,330,400,30);
        add(pnumber); 
        ...
        services.setBounds(100,420,400,20);
        add(services);
        ...
        c7 = new JCheckBox("I hereby declare that the above entered details are corerct to the best of my knowledge");
